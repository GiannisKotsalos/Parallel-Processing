...
The complete project report, including the implementation details, optimization techniques, experimental evaluation, and performance analysis of the Serial, SIMD, OpenMP, MPI, and CUDA implementations, can be found found [here](https://github.com/GiannisKotsalos/Parallel-Processing/raw/refs/heads/main/ParallelProcessing_Report_FinalVersion.docx) (Language: Greek).
